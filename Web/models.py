...
class retele_de_socializare_utilizator(models.Model):
    ...
    instagram = models.CharField(max_length=40, null=True, default='instagram.com/')
    gmail = models.CharField(max_length=40, null=True, default='https://www.instagram.com/')
    ...
    paypal = models.CharField(max_length=40, null=True, default='paypal.me/')
